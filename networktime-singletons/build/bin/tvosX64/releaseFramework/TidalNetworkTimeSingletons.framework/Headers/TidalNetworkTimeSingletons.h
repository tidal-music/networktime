...
__attribute__((swift_name("NetworktimeSNTPClient")))
@interface TNTNetworktimeSNTPClient : TNTBase
- (instancetype)initWithNtpServers:(TNTKotlinArray<TNTNetworktimeNTPServer *> *)ntpServers synchronizationIntervalMs:(int64_t)synchronizationIntervalMs backupFilePath:(NSString * _Nullable)backupFilePath __attribute__((swift_name("init(ntpServers:synchronizationIntervalMs:backupFilePath:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) TNTNetworktimeNTPVersion *ntpVersion __attribute__((swift_name("ntpVersion")));
@property (readonly) TNTKotlinArray<TNTNetworktimeProtocolFamily *> *protocolFamilies __attribute__((swift_name("protocolFamilies")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworktimeProtocolFamily")))
@interface TNTNetworktimeProtocolFamily : TNTKotlinEnum<TNTNetworktimeProtocolFamily *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TNTNetworktimeProtocolFamily *inet __attribute__((swift_name("inet")));
@property (class, readonly) TNTNetworktimeProtocolFamily *inet6 __attribute__((swift_name("inet6")));
+ (TNTKotlinArray<TNTNetworktimeProtocolFamily *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TNTNetworktimeProtocolFamily *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworktimeNTPVersion")))
@interface TNTNetworktimeNTPVersion : TNTKotlinEnum<TNTNetworktimeNTPVersion *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) TNTNetworktimeNTPVersion *zero __attribute__((swift_name("zero")));
@property (class, readonly) TNTNetworktimeNTPVersion *one __attribute__((swift_name("one")));
@property (class, readonly) TNTNetworktimeNTPVersion *two __attribute__((swift_name("two")));
@property (class, readonly) TNTNetworktimeNTPVersion *three __attribute__((swift_name("three")));
@property (class, readonly) TNTNetworktimeNTPVersion *four __attribute__((swift_name("four")));
+ (TNTKotlinArray<TNTNetworktimeNTPVersion *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<TNTNetworktimeNTPVersion *> *entries __attribute__((swift_name("entries")));
@end
